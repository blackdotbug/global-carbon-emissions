...
<svg width={size} height={size} viewBox="0 0 48 48" transform="translate({x}, {y})" class={$$props.class}>
<!-- <g transform={$$props.transform}> -->
    <path fill="#616161" d="M34.6 28.1H38.6V45.1H34.6z" transform="rotate(-45.001 36.586 36.587)"></path>
    <path stroke="#37474F" stroke-width="5" fill="transparent" d="M20 4A16 16 0 1 0 20 36A16 16 0 1 0 20 4Z"></path>
    <path fill="#37474F" d="M36.2 32.1H40.2V44.400000000000006H36.2z" transform="rotate(-45.001 38.24 38.24)"></path>
    <path class="opacity-75" fill="#64B5F6" d="M20 7A13 13 0 1 0 20 33A13 13 0 1 0 20 7Z"></path>
